...
<head>
    ...
    <title>KSJConnects - Complaint (View Complaints)</title>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-hover dataTable table-striped w-full dtr-inline" data-plugin="dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 823px;">
                                    ...
                                    if ($list > 0) {
                                        echo '<thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 127.992px;" aria-sort="ascending" aria-label="Complaint ID: activate to sort column descending">Complaint ID</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="">Reasont</th>
                                        ...
                                        while ($row = mysqli_fetch_assoc($qry)) {
                                            echo '
                                            <tr role="row" >
                                                <td class="sorting_1" tabindex="0">' . $row['complaintID'] . '</td>
